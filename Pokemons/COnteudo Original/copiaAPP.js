...
import Componente_Teste from './COnteudo Original/Componente_Teste';
import {createNativeStackNavigator} from '@react-navigation/native-stack';
import { NavigationContainer } from '@react-navigation/native';
import  Componenteimagem from './COnteudo Original/Componenteimagem';
  ...
  return (
    <NavigationContainer>
      ...
      initialRouteName='inicial' >
        ...
        <Stack.Screen options={{headerShown:false}} name="Home" component={Componente_Teste}/>
